    ...
    it("may return arrays that contains functions and so on", function() {
      function example() {
         ...
         /*
          ...
          - The 0th elem of array is a function
          - The function at 0th elem returns array
            - The 2nd (index = 1) elem of that array should == 10
         */
        var foo = [
          function(num) {
            return [num, num * 10, num * 100];
          }
        ];
        return foo;
      }
    ...
    it("may return arrays that contains closures and so on", function() {
      function example() {
        ...
        return [
          function(n) {
            return [0,
              (n == 1? 10 : (n==2 ? 11 : (n==3? 12 : undefined)))
            ];
          }
        ]
      }
